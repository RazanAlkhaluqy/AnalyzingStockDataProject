...
//StockHistory googleStockHistory = loader.loadStockDataFile("data/real/GOOGL.csv");
		StockHistory googleStockHistory = loader.loadStockDataFile("C:/Users/razan/OneDrive - King Suad University/AnalyzingStockDataProject/data/real/GOOGL.csv");
		if (googleStockHistory == null) {
		    System.out.println("Failed to load Google stock history.");
		    return;
		}
...
//StockHistoryDataSet dataSet = loader.loadStockDataDir("data/real");
		StockHistoryDataSet dataSet = loader.loadStockDataDir("C:/Users/razan/OneDrive - King Suad University/AnalyzingStockDataProject/data/real");
		if (dataSet == null) {
		    System.out.println("Failed to load stock data directory.");
		    return;
		}
